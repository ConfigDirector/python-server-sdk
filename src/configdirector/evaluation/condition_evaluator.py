...
class ConditionEvaluator:
    def evaluate(self, condition: Condition, context: EvaluationContext | None = None) -> bool:
    ...
    def _resolve(self, condition: Condition, context: EvaluationContext | None) -> Any:
