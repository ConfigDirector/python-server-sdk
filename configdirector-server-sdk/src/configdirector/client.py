...
from ._version import SERVER_SDK_IDENTITY, SdkIdentity
...
def _meta_context(metadata: Metadata, sdk_identity: SdkIdentity) -> dict[str, str]:
    ...
    context = {"sdkName": sdk_identity.sdk_name, "sdkVersion": sdk_identity.sdk_version}
